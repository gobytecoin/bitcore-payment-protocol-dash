...
PaymentProtocol.LEGACY_PAYMENT.GBX.REQUEST_CONTENT_TYPE = 'application/gobyte-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.GBX.CONTENT_TYPE = 'application/gobyte-payment';
PaymentProtocol.LEGACY_PAYMENT.GBX.ACK_CONTENT_TYPE = 'application/gobyte-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'GBX';
  this.setObj(obj);
  return this;
};
